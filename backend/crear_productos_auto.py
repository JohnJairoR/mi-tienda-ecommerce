...
def crear_productos(token):
    ...
    productos = [
        ...
        },
        {
            ...
            "slug": "levis-501",
            "description": "Jeans clásicos de corte regular",
            "price": 89.99,
            "stock": 120,
            "sku": "ROPA-003",
            "category_id": 2,
        ...
        },
        {
            ...
            "sku": "ROPA-004",
            "category_id": 2,
            "image_url": "https://images.unsplash.com/photo-1587836374615-91d3f9b6f7f0?w=500"
        },
        {
            "name": "Gafas de Sol Ray-Ban",
            "slug": "rayban-aviator",
            "description": "Gafas de sol estilo aviador clásico",
            "price": 179.99,
            "stock": 40,
            "sku": "ROPA-005",
            "category_id": 2,
        ...
        },
        {
            ...
            "slug": "sarten-tefal",
            "description": "Sartén de 28cm con recubrimiento antiadherente",
            "price": 39.99,
            "stock": 75,
            "sku": "HOGAR-005",
            "category_id": 3,
            "image_url": "https://images.unsplash.com/photo-1556910110-a5a63dfd393c?w=500"
        },
        ...
        },
        {
            ...
            "slug": "mancuernas-20kg",
            "description": "Set de mancuernas de 2-20kg ajustables",
            "price": 199.99,
            "stock": 40,
            "sku": "DEPORTE-002",
            "category_id": 4,
        ...
        },
        {
            ...
            "sku": "DEPORTE-004",
            "category_id": 4,
            "image_url": "https://images.unsplash.com/photo-1614632537190-23e4146777db?w=500"
        },
        {
        ...
        },
        {
            ...
            "slug": "lotr-trilogia",
            "description": "Trilogía completa edición especial",
            "price": 49.99,
            "stock": 40,
            "sku": "LIBRO-002",
            "category_id": 5,
        ...
        },
        {
            "name": "Atomic Habits",
            "slug": "atomic-habits",
            "description": "Un método fácil y comprobado para crear buenos hábitos",
            "price": 19.99,
            "stock": 70,
            "sku": "LIBRO-003",
            "category_id": 5,
        ...
        },
        {
            ...
            "slug": "mochila-northface",
            "description": "Mochila de trekking 40L",
            "price": 129.99,
            "stock": 35,
            "sku": "ROPA-006",
            "category_id": 2,
        ...
        },
        {
            ...
            "slug": "freidora-aire",
            "description": "Freidora sin aceite 5.5L",
            "price": 99.99,
            "stock": 55,
            "sku": "HOGAR-006",
            "category_id": 3,
        ...
        },
        {
            ...
            "slug": "cuerda-saltar",
            "description": "Cuerda de velocidad ajustable",
            "price": 19.99,
            "stock": 100,
            "sku": "DEPORTE-006",
            "category_id": 4,
        ...
        {
            "name": "Harry Potter Colección",
            "slug": "harry-potter-set",
            "description": "Serie completa de 7 libros",
            "price": 89.99,
            "stock": 30,
            "sku": "LIBRO-006",
            "category_id": 5,
    ...
    for producto in productos:
        try:
            ...
            if response.status_code == 201:
                ...
                print(f"❌ Error en {producto['name']}: {response.status_code}")
                errores += 1
        except Exception as e:
            print(f"❌ Excepción en {producto['name']}: {str(e)}")
            errores += 1
...
if __name__ == "__main__":
    print("🚀 Iniciando creación automática de productos...\n")
